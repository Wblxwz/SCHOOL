...
QT_MOC_LITERAL(1, 11, 7), // "GengGai"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "ZhuJieMian\0GengGai\0"
};
...
void ZhuJieMian::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ZhuJieMian *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GengGai(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject ZhuJieMian::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ZhuJieMian.data,
    qt_meta_data_ZhuJieMian,
    qt_static_metacall,
    nullptr,
    nullptr
} };
